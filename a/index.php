...
<div class="container">
	<h1 class="page-header text-center">AVAILABLE PRODUCT</h1>
							...
							?>
								<div class="col-md-3">
									<div class="panel panel-default">
										<div class="panel-heading text-center" style="background:#008000">
											<b><font color="#ffffff"><?php echo $pfrow['productname']; ?></font></b>
										</div>
						...
						while($prow=$pquery->fetch_array()){
							...
							?>
								<div class="col-md-3">
									<div class="panel panel-default">
										<div class="panel-heading text-center" style="background:#008000">
											<b><font color="#ffffff"><?php echo $prow['productname']; ?></font></b>
										</div>
										<div class="panel-body">
											<img src="<?php if($prow['photo']==''){echo "wheat.jpg";} else{echo $prow['photo'];} ?>" height="225px;" width="100%" alt="image not found">
										</div>
										<div class="panel-footer text-center">
